...
export async function run() {
  ...
  console.log("[Analysis Agent] Raw LLM response length:", responseText.length);
  ...
  try {
    ...
    predictions = [{ title: "Parse error", description: responseText, severity: "low", mitigation: "Review manually" }];
  }
